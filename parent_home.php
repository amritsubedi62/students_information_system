...
// Get parent's stored child info
...
.download-btn{display:inline-block;margin:20px 0;padding:10px 20px;background:#d32f2f;color:#fff;text-decoration:none;border-radius:6px;}
