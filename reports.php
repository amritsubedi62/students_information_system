...
$teacher_id = $_SESSION['user_id']; // current teacher
...
if ($selectedClass && $selectedStudent) {
    // check student belongs to that class
    ...
    if (!$studentData) {
        die("Unauthorized student access.");
    }
...
<form method="GET" class="search-form">
  <select name="class" required>
    ...
    <?php
    // only show classes assigned to teacher
    $allowedClasses = [];
    $cls = mysqli_query($conn,"SELECT class FROM teacher_class WHERE teacher_id='$teacher_id'");
    while($c=mysqli_fetch_assoc($cls)) $allowedClasses[]=$c['class'];
